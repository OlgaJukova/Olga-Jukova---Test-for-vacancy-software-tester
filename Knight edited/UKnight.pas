...
type
  TFrm_Knight = class(TForm)
    ...
    procedure AbouttheKnight1Click(Sender: TObject);
...
uses UOptions, UAbout, Unit2, Unit1;
...
begin
 ...
 (* if CellSide >= 60 then CellBitmap.Canvas.Font.Size := 12
  ...
  CellBitmap.Canvas.Font.Size := Round(CellSide/5);
...
begin
 try
  ...
  BoardResize;
    ...
    ShowMessage('¬ведите целые числа');
    Frm_Options.Show;
    end;
end;
...
procedure TFrm_Knight.AbouttheKnight1Click(Sender: TObject);
begin
  AbouttheKnight.Show;

end;

procedure TFrm_Knight.AbouttheProgram1Click(Sender: TObject);
begin
